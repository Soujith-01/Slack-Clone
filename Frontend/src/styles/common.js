...
// ─── User list ────────────────────────────────────────
export const userInfoContainer = "flex items-center justify-between mt-2";
export const userNameText = "text-base font-semibold text-gray-800 tracking-wide";
export const userActionBtnBase = "mt-2 w-fit px-4 py-1.5 text-sm font-medium rounded-md transition-all duration-200";
export const userActionBtnActive = "bg-red-50 text-red-600 hover:bg-red-100";
export const userActionBtnInactive = "bg-green-50 text-green-600 hover:bg-green-100";